...
$router->get('/api/admin/syllabus', function () {
...
$router->post('/api/admin/syllabus', function () {
    try {
...
// POST /api/admin/syllabus/{id}
$router->post('/api/admin/syllabus/{id}', function (array $params) {
    try {
        $user = Auth::requireRole('admin');
...
$router->delete('/api/admin/syllabus/{id}', function (array $params) {
    Auth::requireRole('admin');
